  ...
  const guideSteps = [
    {
      ...
      icon: <Layout size={24} />,
      content: "Select a layout that fits your career stage. Use 'Chronological' for consistent growth, 'Functional' to highlight skills, or 'Combination' for career changers.",
      details: ["Reverse-Chronological (Most Popular)", "Skills-Based", "Hybrid Layouts"]
    },
    {
      title: "Contact Information",
      icon: <UserCircle size={24} />,
      content: "Ensure recruiters can reach you. Include your full name, a professional email, phone number, and location (City, State).",
      details: ["Professional Email Only", "LinkedIn Profile Link", "Job Title Headline"]
    },
    {
      title: "Professional Summary",
      icon: <Sparkles size={24} />,
      content: "A 3-5 sentence 'elevator pitch' that highlights your biggest wins and what you bring to the table.",
      details: ["Focus on achievements", "Use strong action verbs", "Keep it under 5 sentences"]
    },
    {
      title: "Work Experience",
      icon: <Briefcase size={24} />,
      content: "List roles in reverse order. Don't just list tasks—focus on measurable results and impact.",
      details: ["Quantify achievements (%)", "Use Action Verbs", "Limit to last 10-15 years"]
    },
    {
      title: "Skills & Education",
      icon: <GraduationCap size={24} />,
      content: "Balance technical (Hard) skills with interpersonal (Soft) skills. List degrees and relevant certifications.",
      details: ["6-8 Core Skills", "Relevant Certifications", "Degree & Institution"]
    }
  ];
    ...
    <div className="flex flex-col items-center gap-16 lg:flex-row lg:text-left pt-12">
      <div className="flex-1 text-center lg:text-left">
        <div className="inline-flex items-center gap-2 px-4 py-2 mb-8 rounded-full bg-blue-50">
          ...
          <span className="text-xs font-black tracking-widest text-[#0077cc] uppercase">Masterclass 2026</span>
        </div>
        ...
        {guideSteps.map((step, idx) => (
          ...
          >
            <div className="flex items-center gap-6">
              <div className={`h-16 w-16 flex items-center justify-center rounded-[1.5rem] transition-all duration-500 ${
                activeStep === idx 
              ...
              <div className="flex-1">
                ...
                <h3 className="text-xl font-bold text-[#1a2e52] mb-1">{step.title}</h3>
      ...
      <div className="sticky top-24 h-fit p-10 bg-white rounded-[3rem] text-[#1a2e52] border border-gray-100 shadow-[0_20px_50px_rgba(0,0,0,0.04)] overflow-hidden group">
        ...
        <ul className="relative z-10 space-y-6">
          {guideSteps[activeStep].details.map((detail, i) => (
            <li key={i} className="flex items-center gap-4 text-lg font-bold group/item">
          ...
          <div className="grid items-stretch gap-8 md:grid-cols-2">
            <div className="p-8 bg-white border border-red-100 rounded-[2rem] text-left hover:shadow-lg hover:shadow-red-50 hover:-translate-y-1 transition-all duration-300 group">
              ...
              <p className="italic font-medium leading-relaxed text-gray-400">
                "Responsible for managing the sales team and looking after monthly reports."
              </p>
            </div>
            <div className="p-8 bg-white border border-emerald-100 rounded-[2rem] text-left shadow-xl shadow-emerald-50 relative hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 group">
              ...
              <div className="flex items-center gap-2 mb-6 text-xs font-bold tracking-widest uppercase text-emerald-600">
                <CheckCircle2 size={16} className="transition-transform group-hover:scale-110" /> Result-Driven (Strong)
              </div>
              <p className="text-[#1a2e52] font-bold leading-relaxed">
                "Spearheaded a 12-person sales team, delivering a 22% increase in quarterly revenue through targeted lead optimization."
              </p>
            </div>
          </div>
        </div>
  ...
  <div className="mx-auto max-w-7xl">
    ...
    <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
      <div className="p-8 bg-blue-50/50 rounded-[2.5rem] border border-blue-100 hover:bg-blue-50 transition-colors">
        ...
        <h4 className="text-xl font-black text-[#1a2e52] mb-3">Hard Skills</h4>
        <p className="text-sm leading-relaxed text-gray-500">Technical proficiencies, software, and industry-specific tools (e.g., Python, AWS, SQL).</p>
      </div>
      ...
      <div className="p-8 bg-orange-50/50 rounded-[2.5rem] border border-orange-100 hover:bg-orange-50 transition-colors">
        ...
        <h4 className="text-xl font-black text-[#1a2e52] mb-3">Soft Skills</h4>
        <p className="text-sm leading-relaxed text-gray-500">Interpersonal abilities like leadership, communication, and strategic problem-solving.</p>
      </div>
      ...
      <div className="p-8 bg-purple-50/50 rounded-[2.5rem] border border-purple-100 hover:bg-purple-50 transition-colors">
        ...
        <h4 className="text-xl font-black text-[#1a2e52] mb-3">Certifications</h4>
        <p className="text-sm leading-relaxed text-gray-500">Proof of ongoing education and verified expertise from recognized institutions.</p>
      </div>
    </div>
  </div>
</section>
