          ...
          >
            ...
            >
              ...
              <p className="max-w-xl mx-auto mb-12 text-xl font-medium text-gray-500 lg:mx-0">
                Manage every version and land interviews faster with your
                centralized career command center.
              </p>
            ...
            >
              ...
              {/* Floating Badge */}
              <div
                className="absolute hidden md:flex items-center gap-3 p-4 bg-white border border-gray-100 shadow-xl rounded-2xl bottom-10 right-10 animate-bounce"
      ...
      <section className="px-8 py-20 bg-white font-['Outfit']">
        ...
        >
          ...
          <div className="mb-12 space-y-6 text-lg text-gray-600">
            <p>
              Resume Hub is your centralized command center for managing every
              version of your professional identity. Instead of juggling
              multiple PDF files and messy folders, our hub allows you to store,
              organize, and track your resumes and cover letters in one secure,
              cloud-based environment.
            </p>
            <p>
              By leveraging our intelligent version control, you can quickly
              duplicate and tailor documents for different industries while
              maintaining a master record of your achievements. It is designed
              to streamline the application process, ensuring you always send
              the right document to the right recruiter at the right time.
            </p>
          </div>
          ...
          <div className="bg-[#f0f7ff] border-l-4 border-[#0077cc] rounded-2xl p-5 shadow-xl sm:p-8">
            ...
            <ul className="space-y-4">
              {[
                {
                  title: "Cloud Storage",
                  desc: "Access your career documents from any device, anywhere.",
                },
                {
                  title: "Version Control",
                  desc: "Keep track of multiple versions tailored for different job roles.",
                },
                {
                  title: "One-Click Duplication",
                  desc: "Easily clone your best resume to start a new application.",
                },
                {
                  title: "Organized Workspace",
                  desc: "Tag and filter documents by industry or application status.",
                },
              ].map((item, i) => (
...
>
        <div className="mx-auto max-w-7xl">
          <motion.div
            ...
            whileInView="show"
            viewport={{ once: true }}
            className="bg-white rounded-[2.5rem] border border-gray-100 shadow-2xl overflow-hidden transition-all duration-500"
          >
                    ...
                    >
                      <td className="px-6 py-5 border-l border-gray-100 rounded-l-2xl border-y">
                        <div className="flex items-center gap-3">
                          ...
                          <span className="font-bold text-[#1a2e52]">
                            {row.title}
                          </span>
                        </div>
                      </td>
                      <td className="px-6 py-5 text-center border-gray-100 border-y">
                        <div
                          className={`inline-flex items-center gap-1 font-black ${row.color}`}
                        >
                      ...
                      <td className="px-6 py-5 text-right border-r border-gray-100 rounded-r-2xl border-y">
                        <div className="flex items-center justify-end gap-2">
                          <button className="p-2 text-gray-400 hover:text-[#0077cc]">
                            <Eye size={18} />
                          </button>
                          <button className="p-2 text-gray-400 hover:text-[#0077cc]">
                            <Download size={18} />
...
>
        <div className="mx-auto max-w-7xl">
          <div className="mb-16 text-center">
            ...
            <h3 className="text-4xl font-black text-[#1a2e52] font-jakarta tracking-tight">
            ...
            {[
              {
                ...
                desc: "Duplicate any master resume to tailor for a specific job in one click.",
              },
              {
                icon: <BarChart3 />,
                title: "Score Tracking",
                desc: "Monitor the 'Hire-ability' score of every version in your dashboard.",
              },
              {
                icon: <History />,
                title: "Export History",
                desc: "Track every time your resume was exported or shared with a recruiter.",
              },
              {
                icon: <Clock />,
                title: "Version Control",
                desc: "Access and restore any previous edit from your career timeline.",
              },
            ].map((item, i) => (
              <motion.div
                key={i}
...
>
        ...
        >
          ...
          <p className="max-w-2xl mx-auto mb-10 text-xl font-medium text-gray-500">
            Manage every version, track real-time performance, and keep your job
            search organized in one central location.
          </p>
