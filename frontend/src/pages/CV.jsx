...
const CVFormattingPage = () => {
          ...
          >
            ...
            >
              ...
              <p className="max-w-xl mx-auto mb-10 text-xl font-medium leading-relaxed text-gray-500 lg:mx-0">
                Design matters as much as data. We transform messy documents
                into clean, high-impact narratives that recruiters scan in{" "}
                <span className="font-bold text-[#1a2e52]">6 seconds</span>.
              </p>
            ...
            >
              <div
                className="absolute z-20 hidden p-4 bg-white border border-gray-100 shadow-xl -top-6 -left-6 rounded-2xl md:block animate-bounce"
                style={{ animationDuration: "4s" }}
              >
                <div className="flex items-center gap-3">
                  <div className="p-2 rounded-lg bg-blue-50">
                    <CheckCircle2 className="text-[#0077cc]" size={18} />
                  </div>
                  <span className="text-xs font-bold tracking-tight text-[#1a2e52]">
                    Recruiter Approved
                  </span>
                </div>
              </div>
      ...
      <section className="px-8 py-20 bg-white font-['Outfit']">
        ...
        >
          ...
          <div className="mb-12 space-y-6 text-lg text-gray-600">
            <p>
              Professional CV formatting is the architectural process of
              organizing your career history into a high-impact visual
              narrative. It ensures that your most impressive achievements are
              positioned where a recruiter's eye naturally lands during a
              6-second scan.
            </p>
            <p>
              Our AI-driven formatter goes beyond simple templates; it optimizes
              font hierarchy, white space, and section zoning to ensure your
              document is beautiful to humans and perfectly readable by
              machines. We turn messy drafts into polished, recruiter-approved
              masterpieces.
            </p>
          </div>
          ...
          <div className="bg-[#f0f7ff] border-l-4 border-[#0077cc] rounded-2xl p-8 shadow-sm">
            <h3 className="text-xl font-bold text-[#1a2e52] mb-6">
              Our CV Architect focuses on:
            </h3>
            <ul className="space-y-4">
              {[
                {
                  title: "Information Hierarchy",
                  desc: "Prioritizes your most relevant achievements at the top.",
                },
                {
                  title: "Typography Optimization",
                  desc: "Uses professional font pairings for maximum screen readability.",
                },
                {
                  title: "ATS-Safe Elements",
                  desc: "Removes graphics or tables that could break digital scanning.",
                },
                {
                  title: "Visual Balance",
                  desc: "Adjusts margins and spacing to eliminate 'wall of text' fatigue.",
                },
              ].map((item, i) => (
      ...
      <section className="px-8 py-20 bg-white overflow-hidden font-['Outfit']">
        ...
        >
          <div className="mb-16 text-center duration-700 animate-in fade-in slide-in-from-bottom-6">
            <h2 className="text-4xl font-[1000] tracking-tight text-[#1a2e52] mb-4">
              Visual Impact Analysis
            </h2>
            <p className="max-w-xl mx-auto font-medium text-gray-500">
              See how our AI restructures messy data into high-performance
          ...
          <div className="grid items-stretch gap-8 md:grid-cols-2 group/container">
            {/* --- BOX 1: THE "BEFORE" --- */}
            <div
              className="p-10 bg-slate-50 rounded-[40px] border border-slate-200 opacity-80 
  ...
  flex flex-col justify-between active:scale-[0.98] group cursor-default"
                ...
                <div className="mb-8 space-y-4 transition-transform duration-500 group-hover:translate-x-1">
                  ...
                  <div className="space-y-3">
                    <p className="text-xs font-medium leading-relaxed transition-colors text-slate-500 group-hover:text-slate-800">
                      I was responsible for managing a team of 10 people and we
                      worked on software projects. I attended daily meetings and
                      made sure everyone was doing their tasks on time. I also
                      used Jira to track bugs and spoke to stakeholders about
                      the progress of the project every week. It was a very busy
            ...
            <div className="p-10 bg-white rounded-[40px] border-2 border-blue-600 shadow-2xl shadow-blue-900/10 relative transition-all duration-700 hover:-translate-y-4 hover:shadow-blue-500/20 group flex flex-col justify-between z-10 hover:blur-none! active:scale-[0.98]">
              ...
              <div>
                <span className="block mb-6 text-xs font-black tracking-[0.2em] text-blue-600 uppercase">
                  Smart Hierarchy
                </span>

                <div className="mb-8 space-y-5">
                  <div className="flex items-start justify-between">
                    <h4 className="text-xl font-black text-[#1a2e52] tracking-tight group-hover:text-blue-600 transition-colors">
                      Project Manager
                    </h4>
                    <span className="text-[10px] font-bold text-blue-600 bg-blue-50 px-2 py-1 rounded group-hover:bg-blue-600 group-hover:text-white transition-all duration-500">
                      TechCorp
                    </span>
                  </div>
                  ...
                  <ul className="space-y-3">
                    {[
                      {
                        val: "15+ software releases",
                        text: "Led a cross-functional team of 10 to deliver ",
                        post: " 2 weeks ahead of schedule.",
                      },
                      {
                        val: "35%",
                        text: "Reduced bug resolution time by ",
                        post: " through advanced Jira workflow optimization.",
                      },
                      {
                        val: "$2M budget",
                        text: "Managed a ",
                        post: ", identifying cost-saving measures that saved $200k annually.",
                      },
                    ].map((item, i) => (
                      <li
                        key={i}
                      ...
                      >
                        ...
                        <p className="text-xs font-semibold text-slate-700">
                          {item.text}
                          <span className="font-bold text-blue-600 transition-all group-hover:underline decoration-blue-200 underline-offset-2">
                            {item.val}
                          </span>
                          {item.post}
                        </p>
              ...
              <div className="pt-6 border-t border-blue-50">
                ...
                <div className="flex flex-wrap gap-2 mt-3">
                  {["Data-Driven", "Action Verbs", "Skimmable"].map(
                    (tag, i) => (
                      <span
                        key={i}
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
            {[
              ...
              >
                ...
                <div
                  className={`mb-8 p-6 rounded-3xl ${step.bg} transition-transform duration-500 group-hover:scale-110 group-hover:rotate-3`}
                >
      ...
      <section className="px-8 mx-auto py-10 max-w-7xl">
        ...
        >
          <div className="p-10 bg-slate-50 rounded-[40px] flex flex-col justify-between transition-all duration-500 hover:bg-slate-100 hover:-translate-y-2 hover:shadow-xl group cursor-default">
            <MousePointerSquareDashed
              className="mb-6 text-blue-600 transition-transform duration-500 group-hover:scale-125"
              size={32}
            />
            <div>
              <h4 className="mb-2 text-2xl font-black">Pixel Perfect</h4>
              <p className="text-sm font-medium text-slate-500">
                Every line, dot, and margin is aligned to professional design
                standards.
              </p>
            </div>
          </div>
          <div className="p-10 bg-blue-50 rounded-[40px] flex flex-col justify-between transition-all duration-500 hover:bg-blue-100 hover:-translate-y-2 hover:shadow-xl group cursor-default">
            <Download
              className="mb-6 text-blue-600 transition-transform duration-500 group-hover:scale-125 group-hover:animate-bounce"
              size={32}
            />
            <div>
              <h4 className="mb-2 text-2xl font-black">Export Ready</h4>
              <p className="text-sm font-medium text-slate-500">
                Optimized for PDF export so your layout never breaks across
                systems.
              </p>
            </div>
          </div>
          <div className="p-10 bg-[#1a2e52] text-white rounded-[40px] flex flex-col justify-between transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl hover:shadow-blue-900/20 group cursor-default">
            <CheckCircle2
              className="mb-6 text-blue-400 transition-transform duration-500 group-hover:scale-125"
              size={32}
            />
            <div>
              <h4 className="mb-2 text-2xl font-black">ATS Friendly</h4>
              <p className="text-sm font-medium text-blue-200/60">
                Beautiful to humans, perfectly readable by application software.
              </p>
            </div>
          </div>
        </motion.div>
      ...
      <section className="relative px-8 pt-12 pb-15 overflow-hidden bg-white">
        ...
        >
          ...
          <p className="mb-10 text-xl font-medium text-gray-500">
            Design matters. Turn your career history into a clean,
            recruiter-approved masterpiece in seconds.
          </p>
          <button
            onClick={() => navigate("/register")}
