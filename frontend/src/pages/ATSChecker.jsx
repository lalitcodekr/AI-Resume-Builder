 ...
 const navigate = useNavigate();
  ...
  return (
    <div className="min-h-screen bg-[#FDFDFD] font-['Outfit'] select-none overflow-x-hidden">
      ...
      {/* 1) HERO SECTION */}
      <section ref={heroRef} className="relative px-4 sm:px-6 lg:px-8 pt-12 sm:pt-14 lg:pt-16 pb-14 sm:pb-16 lg:pb-20 overflow-hidden bg-white">
        ...
        <div className="mx-auto max-w-7xl">
          <div className="grid items-center gap-10 md:gap-12 lg:gap-16 lg:grid-cols-2">
            <div className={`min-w-0 transition-all duration-700 ${heroVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}>
            ...
            <div className={`relative min-w-0 transition-all duration-700 delay-100 ${heroVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
              <div className="relative max-w-md mx-auto lg:mr-0">
                <div className="relative pl-14 sm:pl-16 md:pl-20 lg:pl-24">
                  <div className="absolute left-0 bottom-0 z-20 pointer-events-none">
                    <img
                      src={Lady}
                      alt="Character pointing to ATS score"
                      className="w-24 sm:w-28 md:w-32 lg:w-36 xl:w-40 2xl:w-48 object-contain"
                    />
                  </div>
